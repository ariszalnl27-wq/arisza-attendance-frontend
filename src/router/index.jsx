...
export default function AppRouter() {
  return (
    <Routes>
      ...
      <Route path="/attendance" element={<RequireAuth><UserLayout><AttendancePage /></UserLayout></RequireAuth>} />
      <Route path="/points" element={<RequireAuth><UserLayout><PointsPage /></UserLayout></RequireAuth>} />
      <Route path="/profile" element={<RequireAuth><UserLayout><ProfilePage /></UserLayout></RequireAuth>} />

      {/* Admin routes */}
      <Route path="/admin/dashboard" element={<RequireAdmin><AdminLayout><AdminDashboardPage /></AdminLayout></RequireAdmin>} />
      <Route path="/admin/attendances" element={<RequireAdmin><AdminLayout><AdminAttendancesPage /></AdminLayout></RequireAdmin>} />
      <Route path="/admin/redemptions" element={<RequireAdmin><AdminLayout><AdminRedemptionsPage /></AdminLayout></RequireAdmin>} />
      <Route path="/admin/users" element={<RequireAdmin><AdminLayout><AdminUsersPage /></AdminLayout></RequireAdmin>} />
      <Route path="/admin/qr" element={<RequireAdmin><AdminLayout><AdminQRPage /></AdminLayout></RequireAdmin>} />
...
function NotFound() {
  ...
  return (
    <div className="min-h-dvh flex flex-col items-center justify-center text-center p-6">
      ...
      <a href={home} className="btn btn-primary">Kembali ke Beranda</a>
    </div>
  )
}
